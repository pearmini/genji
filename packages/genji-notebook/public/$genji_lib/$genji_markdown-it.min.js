...
!(function (e, r) {
  ...
  function W(e) {
    ...
    for (r = e.length - 1; r >= 0; r--)
      "text" !== (t = e[r]).type || n || (t.content = t.content.replace($, J)),
          ...
          if (e.md.options.typographer)
            for (r = e.tokens.length - 1; r >= 0; r--)
              "inline" === e.tokens[r].type &&
                (G.test(e.tokens[r].content) && W(e.tokens[r].children),
  ...
  for (var Ie = w.isSpace, Me = w.isSpace, Re = [], Be = 0; Be < 256; Be++)
    Re.push(0);
  ...
  var je = {
    ...
    Je = Ae.HTML_TAG_RE;
  var We = w.has,
    Ye = w.isValidEntityCode,
    Ke = w.fromCodePoint,
    Qe = /^&#((?:x[a-f0-9]{1,6}|[0-9]{1,7}));/i,
  ...
  (sr.prototype.pushPending = function () {
    ...
    (sr.prototype.push = function (e, r, t) {
    ...
    (sr.prototype.scanDelims = function (e, r) {
      var t,
        n,
        s,
        o,
      ...
      return (
        ...
        (c = nr(t) || tr(String.fromCharCode(t))),
        (u = nr(n) || tr(String.fromCharCode(n))),
        (a = rr(t)),
        (l = rr(n)) ? (h = !1) : u && (a || c || (h = !1)),
        a ? (f = !1) : c && (l || u || (f = !1)),
        r ? ((o = h), (i = f)) : ((o = h && (!f || c)), (i = f && (!h || u))),
        { can_open: o, can_close: i, length: s }
      );
    }),
    (sr.prototype.Token = oe);
  var or = sr,
    ir = [
      [
        "text",
      ...
      [
        ...
        function (e, r) {
          ...
          if (++n < s) {
            if ((t = e.src.charCodeAt(n)) < 256 && 0 !== Re[t])
              return r || (e.pending += e.src[n]), (e.pos += 2), !0;
            if (10 === t) {
              for (
                r || e.push("hardbreak", "br", 0), n++;
                n < s && ((t = e.src.charCodeAt(n)), Me(t));
      ...
      [
        ...
        function (e, r) {
          ...
          if ((a = o + 1) < f && 40 === e.src.charCodeAt(a)) {
            for (
              m = !1, a++;
              a < f && ((n = e.src.charCodeAt(a)), Ve(n) || 10 === n);
              a++
            );
            if (a >= f) return !1;
            if (
                  ...
                  t ||
                    ((n =
                      "x" === s[1][0].toLowerCase()
                        ...
                        : parseInt(s[1], 10)),
                    (e.pending += Ye(n) ? Ke(n) : Ke(65533))),
                  (e.pos += s[0].length),
                  !0
                );
            } else if ((s = e.src.slice(o).match(Xe)) && We(r, s[1]))
      ...
      [
        ...
        function (e) {
          var r,
            t = e.tokens_meta,
            n = e.tokens_meta.length;
          for (er(0, e.delimiters), r = 0; r < n; r++)
            t[r] && t[r].delimiters && er(0, t[r].delimiters);
        },
      ],
  ...
  function cr() {
    var e;
    for (this.ruler = new O(), e = 0; e < ir.length; e++)
      this.ruler.push(ir[e][0], ir[e][1]);
    for (this.ruler2 = new O(), e = 0; e < ar.length; e++)
      this.ruler2.push(ar[e][0], ar[e][1]);
  }
  (cr.prototype.skipToken = function (e) {
    var r,
      t,
      n = e.pos,
      s = this.ruler.getRules(""),
    ...
    (cr.prototype.parse = function (e, r, t, n) {
      var s,
        o,
        i,
  ...
  function hr(e) {
    return "[object Function]" === pr(e);
  }
  function fr(e) {
    return e.replace(/[.?*+^$[\]\\(){}|-]/g, "\\$&");
  }
  var dr = { fuzzyLink: !0, fuzzyEmail: !0, fuzzyIP: !1 };
  var mr = {
      "http:": {
    ...
    (e.__compiled__ = {}),
      Object.keys(e.__schemas__).forEach(function (r) {
        ...
        if (null !== t) {
          ...
          if (((e.__compiled__[r] = n), "[object Object]" === pr(t)))
            return (
              !(function (e) {
                return "[object RegExp]" === pr(e);
              })(t.validate)
                ? hr(t.validate)
  ...
  function vr(e, r) {
    ...
    r ||
      ...
      Object.keys(t || {}).reduce(function (e, r) {
        return e || dr.hasOwnProperty(r);
      }, !1) && ((r = e), (e = {}))),
      (this.__opts__ = ur({}, dr, r)),
      (this.__index__ = -1),
      (this.__last_index__ = -1),
      (this.__schema__ = ""),
      (this.__text_cache__ = ""),
      (this.__schemas__ = ur({}, mr, e)),
      (this.__compiled__ = {}),
      (this.__tlds__ = gr),
  ...
  (vr.prototype.add = function (e, r) {
    return (this.__schemas__[e] = r), _r(this), this;
  }),
    (vr.prototype.set = function (e) {
      return (this.__opts__ = ur(this.__opts__, e)), this;
    }),
    ...
    (vr.prototype.pretest = function (e) {
      return this.re.pretest.test(e);
    }),
    (vr.prototype.testSchemaAt = function (e, r, t) {
      return this.__compiled__[r.toLowerCase()]
        ? this.__compiled__[r.toLowerCase()].validate(e, t, this)
        : 0;
    }),
    (vr.prototype.match = function (e) {
      var r = 0,
        t = [];
      this.__index__ >= 0 &&
        this.__text_cache__ === e &&
        (t.push(br(this, r)), (r = this.__last_index__));
    ...
    (vr.prototype.tlds = function (e, r) {
      return (
    ...
    (vr.prototype.normalize = function (e) {
      e.schema || (e.url = "http://" + e.url),
        "mailto:" !== e.schema ||
          /^mailto:/i.test(e.url) ||
          (e.url = "mailto:" + e.url);
    }),
    (vr.prototype.onCompile = function () {});
  var Cr = vr,
    yr = 2147483647,
    Ar = 36,
    xr = /^xn--/,
  ...
  /*! https://mths.be/punycode v1.4.1 by @mathias */ function Fr(e) {
    throw new RangeError(Er[e]);
  }
  function Lr(e, r) {
  ...
  function zr(e, r) {
    ...
    return (
      ...
      n + Lr((e = e.replace(wr, ".")).split("."), r).join(".")
    );
  }
  function Tr(e) {
  ...
  function Rr(e, r, t) {
    var n = 0;
    for (e = t ? qr(e / 700) : e >> 1, e += qr(e / r); e > 455; n += Ar)
      e = qr(e / 35);
    return qr(n + (36 * e) / (e + 38));
  }
  function Br(e) {
    var r,
      t,
    ...
    for ((t = e.lastIndexOf("-")) < 0 && (t = 0), n = 0; n < t; ++n)
      e.charCodeAt(n) >= 128 && Fr("not-basic"), h.push(e.charCodeAt(n));
    for (s = t > 0 ? t + 1 : 0; s < f; ) {
      for (
        o = d, i = 1, a = Ar;
        s >= f && Fr("invalid-input"),
          ((c =
        ...
        i > qr(yr / (u = Ar - l)) && Fr("overflow"), (i *= u);
      (g = Rr(d - o, (r = h.length + 1), 0 == o)),
        qr(d / r) > yr - m && Fr("overflow"),
        (m += qr(d / r)),
        (d %= r),
        h.splice(d++, 0, m);
    }
  ...
  function Nr(e) {
    var r,
      ...
      m,
      g = [];
    for (h = (e = Tr(e)).length, r = 128, t = 0, o = 72, i = 0; i < h; ++i)
      (p = e[i]) < 128 && g.push(Sr(p));
    for (n = s = g.length, s && g.push("-"); n < h; ) {
      for (a = yr, i = 0; i < h; ++i) (p = e[i]) >= r && p < a && (a = p);
      for (
        a - r > qr((yr - t) / (f = n + 1)) && Fr("overflow"),
          t += (a - r) * f,
          r = a,
          i = 0;
        i < h;
        ...
        if (((p = e[i]) < r && ++t > yr && Fr("overflow"), p == r)) {
          for (
            c = t, l = Ar;
            ...
            (m = c - u),
              (d = Ar - u),
              g.push(Sr(Mr(u + (m % d), 0))),
              (c = qr(m / d));
          g.push(Sr(Mr(c, 0))), (o = Rr(t, f, n == s)), (t = 0), ++n;
        }
      ++t, ++r;
    }
    return g.join("");
  ...
  function Or(e) {
    return zr(e, function (e) {
      return xr.test(e) ? Br(e.slice(4).toLowerCase()) : e;
    });
  }
  function Pr(e) {
    return zr(e, function (e) {
      return Dr.test(e) ? "xn--" + Nr(e) : e;
    });
  }
  var jr = "1.4.1",
    Ur = { decode: Tr, encode: Ir },
    Vr = {
      version: jr,
      ucs2: Ur,
      toASCII: Pr,
  ...
  function Jr(e) {
    ...
    return !$r.test(r) || !!Hr.test(r);
  }
  var Wr = ["http:", "https:", "mailto:"];
  function Yr(e) {
    var r = C.parse(e, !0);
    if (r.hostname && (!r.protocol || Wr.indexOf(r.protocol) >= 0))
      try {
        r.hostname = Zr.toASCII(r.hostname);
      } catch (e) {}
  ...
  function Kr(e) {
    ...
    if (r.hostname && (!r.protocol || Wr.indexOf(r.protocol) >= 0))
      try {
        r.hostname = Zr.toUnicode(r.hostname);
      } catch (e) {}
    return C.decode(C.format(r), C.decode.defaultChars + "%");
  }
  function Qr(e, r) {
    if (!(this instanceof Qr)) return new Qr(e, r);
    r || w.isString(e) || ((r = e || {}), (e = "default")),
      ...
      (this.normalizeLink = Yr),
      (this.normalizeLinkText = Kr),
      (this.utils = w),
  ...
  return (
    (Qr.prototype.set = function (e) {
      return w.assign(this.options, e), this;
    }),
    (Qr.prototype.configure = function (e) {
      var r,
        t = this;
    ...
    (Qr.prototype.enable = function (e, r) {
      var t = [];
      Array.isArray(e) || (e = [e]),
    ...
    (Qr.prototype.disable = function (e, r) {
      var t = [];
      Array.isArray(e) || (e = [e]),
        ["core", "block", "inline"].forEach(function (r) {
    ...
    (Qr.prototype.parseInline = function (e, r) {
      var t = new this.core.State(e, this, r);
      return (t.inlineMode = !0), this.core.process(t), t.tokens;
    }),
    (Qr.prototype.renderInline = function (e, r) {
      return (
        (r = r || {}),
